/** Contacto del entrenador (Gabo) para avisos de pago y mora. */
export const COACH_DISPLAY_NAME = 'Gabo';
export const COACH_PHONE_DISPLAY = '+52 1 56 3233 2292';
export const COACH_PHONE_TEL = '+5215632332292';
